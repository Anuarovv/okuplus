...
@section('content')
    ...
    <!-- Statistic -->
    <div class="content-wrapper mw-100" style="min-height: 906px;">
                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            ...
                            <img class="profile-user-img img-responsive img-circle" src="https://sun9-42.userapi.com/c623216/v623216523/5ebb6/xTPWMvpibTk.jpg" alt="User profile picture">

                            <h3 class="profile-username text-center">Ulugbek Anuarov</h3>

                            <p class="text-muted text-center">Founder OKUPLUS</p>

                            <ul class="list-group list-group-unbordered">
                                <li class="list-group-item">
                                    <b>Роль</b> <a class="pull-right">Admin</a>
                                </li>
                                <li class="list-group-item">
                                    <b>E-mail</b><a class="pull-right">uanuarov@gmail.com</a>
                                </li>
                                <li class="list-group-item">
                                    <b>Курсы</b> <a class="pull-right">3</a>
                                </li>
                            </ul>
                        </div>
                        <!-- /.box-body -->
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            ...
                            <strong><i class="fa fa-map-marker margin-r-5"></i> Локация</strong>

                            <p class="text-muted">Almaty, Kazakhstan</p>
